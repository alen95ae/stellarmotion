...
export default function PlanillaSueldosReporte() {
    ...
    <>
      ...
      <div className="p-6 space-y-6">
        <div className="rounded-md border border-blue-200 bg-blue-50 px-4 py-3">
          <h1 className="text-lg font-bold text-blue-900 tracking-wide">PLANILLA DE SUELDOS</h1>
          <p className="text-xs text-blue-800 mt-1">Estructura preparada para PDF/Excel (mock).</p>
        </div>

        <PlanillasInformesFiltros value={filtros} onChange={setFiltros} />

        <PlanillasInformesAcciones onGenerar={() => toast.info("Mock: Generar reporte de Planilla de Sueldos")} />
      </div>
    </>
  )
}
