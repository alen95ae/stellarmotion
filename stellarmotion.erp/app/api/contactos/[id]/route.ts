...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/contactos/[id]:", e);
    const err = e instanceof Error ? e : new Error(String(e));
    return NextResponse.json(
      { error: err.message || "Error al obtener el contacto", details: err.message },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    console.error("PUT /api/contactos/[id]:", e);
    const err = e instanceof Error ? e : new Error(String(e));
    return NextResponse.json(
      { error: err.message || "Error al actualizar el contacto", details: err.message },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    const err = e instanceof Error ? e : new Error(String(e));
    return NextResponse.json(
      { error: err.message || "Error al eliminar el contacto", details: err.message },
      { status: 500 }
    );
  }
}
