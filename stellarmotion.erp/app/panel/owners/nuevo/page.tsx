...
export default function NuevoOwnerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Owner creado");
      setSaved(true);
      setTimeout(() => router.push(`/panel/owners/${created.id}`), 1200);
  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="w-full px-6 py-8">
        <div className="mb-6">
          <h1 className="text-3xl font-semibold text-foreground">Nuevo owner</h1>
          <p className="text-muted-foreground text-sm mt-1">Añade un nuevo Owner a tu base de datos.</p>
        </div>
