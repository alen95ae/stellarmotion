...
const rankingClientes = [
  { cliente: 'Coca Cola Bolivia', gasto: 25000, alquileres: 3, porcentaje: 35 },
  { cliente: 'Banco Nacional', gasto: 18500, alquileres: 2, porcentaje: 26 },
  { cliente: 'Supermercados Ketal', gasto: 12300, alquileres: 2, porcentaje: 17 },
  { cliente: 'Cervecería Nacional', gasto: 8900, alquileres: 1, porcentaje: 12 },
  { cliente: 'Telecom Bolivia', gasto: 5200, alquileres: 1, porcentaje: 7 }
];
              ...
              <div key={cliente.cliente} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-gray-500">
                    {cliente.alquileres} alquiler{cliente.alquileres !== 1 ? 'es' : ''}
                  </div>
                </div>
